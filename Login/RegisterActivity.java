...
public class RegisterActivity extends Activity {
    private Button REGISTER_FINISH,REGISTER_CHECK,AVATER;
            ...
            public void onClick(View v) {
                if(judge==1||flag==1)
                {
                    new Thread() {
                        public void run() {
                            try {;
                                code = USER_DATA.register_function(phoneNum,password,userName,sex,USER_DATA.getStyle(),requestion,answer, register_avater);
